...
categoryData("http://localhost:8000/api/category");
//product data
...
function quickViewFunc(id) {
  ...
  productQuickViewCard.innerHTML = `<div class="quick-img" bis_skin_checked="1"><img src="http://localhost:8000/storage/image/${
    data.image.split(",")[0]
  }" alt=""></div>
